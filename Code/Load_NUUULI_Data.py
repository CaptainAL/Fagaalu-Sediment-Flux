...
TAFUNAbaro = TAFUNAbaro.reindex(pd.date_range(min(TAFUNAbaro.index),max(TAFUNAbaro.index),freq='15Min'))##load data from NDBC NSTP6 station at DMWR, Pago Harbor
