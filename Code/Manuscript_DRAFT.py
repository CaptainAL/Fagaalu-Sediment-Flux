...
plot_storm_individually(All_Storms.loc[121],show=False,save=True,filename=Example_Storm['filename']) 
example_storm_start =  All_Storms.loc[121]['start']
