...
'SSY Qmax':['-','-','-','-','-','-']}, index=['Precip(mm)','UPPER','LOWER','LOWER_QUARRY','LOWER_VILLAGE','TOTAL'])
Annual_SSY_table = Annual_SSY_table[['SSY Table 2','SSY Table 3','SSY ALL','SSY Qmax']]
...
'sSSY Qmax':['-','-','-','-','-','-']}, index=['Precip(mm)','UPPER','LOWER','LOWER_QUARRY','LOWER_VILLAGE','TOTAL'])
Annual_sSSY_table = Annual_sSSY_table[['sSSY Table 2','sSSY Table 3','sSSY ALL','sSSY Qmax']]
