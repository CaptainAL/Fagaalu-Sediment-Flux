...
document.add_paragraph("Two approaches were used to determine relative contributions to total SSY from the undisturbed and human-disturbed areas: comparing individual event and average percent contributions, and the Disturbance Ratio (DR).")
