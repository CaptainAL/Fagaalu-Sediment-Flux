...
document.add_paragraph("Faga'alu watershed can be divided into two subwatersheds: 1) an upper subwatershed characterized by large areas of undisturbed, steeply-sloping, heavily forested hillsides (UPPER), and 2) a lower subwatershed wtih similarly steep forested topography and relatively small flat areas that are urbanized or densely settled (LOWER) (Figure "+Study_Area_map['fig_num']+"). The LOWER subwatershed can be further divided into a LOWER_QUARRY subwatershed, draining areas between FG1 and FG2, and a LOWER_VILLAGE subwatershed, draining areas between FG2 and FG3. This settlement pattern is typical for volcanic islands with steep topography in the south Pacific. Land use in Faga'alu watershed includes agriculture, roads, and urbanization (Table "+landcover_table.table_num+"), but the predominant land cover is undisturbed forest on the steep hillsides ("+"%.1f"%landcover_table.ix[5]['% Forest']+"%).")
document.add_paragraph("The Faga'alu watershed includes two unique features not found in "+'"typical"'+" watersheds in American Samoa: 1) an open aggregate quarry in the  LOWER_QUARRY subwatershed, upstream of FG2 in Figure "+Study_Area_map['fig_num']+"), and 2) a large impervious area associated with a hospital in the LOWER_VILLAGE subwatershed (adjacent FG3 in Figure "+Study_Area_map['fig_num']+"). Three water impoundment structures were built in the UPPER subwatershed for drinking water supply and hydropower but only the highest, Matafao Reservoir, was ever connected to the municipal water system and has since fallen out of use (Tonkin & Taylor International Ltd., 1989)(Figure "+Study_Area_map['fig_num']+"). A full description of stream impoundments is in the Appendix.")
...
document.add_paragraph("A main objective for this study was to determine how much human disturbance has increased Total SSY to Faga'alu Bay (SSYTOTAL). Two approaches were used to determine relative contributions to SSYTOTAL from the undisturbed and human-disturbed areas: comparing individual event and average percent contributions, and the Disturbance Ratio (DR). The disturbance ratio (DR) is the ratio of SSYEV from the total human-disturbed watershed under current conditions, SSYTOTAL (measured at the watershed outlet FG3), to SSY under pre-disturbance conditions (SSYPRE):")
...
## Disturbance Ratio
document.add_paragraph("The DR is the ratio of sSSY from the watershed under current human-disturbed conditions to sSSY under pre-disturbance conditions (SSYPRE)(Equation "+DR_eq.eq_num +"). The UPPER subwatershed is undisturbed, so SSYPRE is assumed to be equal to SSYUPPER. This assumes that prior to humans altering the land cover the whole watershed was covered in forest, and the sSSY of the whole watershed was the same as the forest area currently covering the UPPER subwatershed. Comparing sSSY from the undisturbed UPPER watershed and the disturbed LOWER watershed shows sSSY has been increased by "+S_Diff_table['LOWER tons']['DR']+"x in the LOWER subwatershed, and "+S_Diff_table['TOTAL tons']['DR']+"x for the TOTAL watershed.") 
