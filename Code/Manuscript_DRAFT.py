...
alpha_upper, beta_upper = ratings_table['alpha'].loc['Qmax_upper'], "%.1f"%10**float(ratings_table['Beta'].loc['Qmax_upper'])
alpha_total, beta_total = ratings_table['alpha'].loc['Qmax_total'], "%.1f"%10**float(ratings_table['Beta'].loc['Qmax_total'])
