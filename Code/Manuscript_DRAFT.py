...
Percent_Upper_S_min, Percent_Upper_S_max =  "%.0f"%S_Diff_table_percents['% UPPER'].astype(float).min(), "%.0f"%S_Diff_table_percents['% UPPER'].astype(float).max()
...
document.add_paragraph("The UPPER and LOWER subwatersheds are similar in size, 0.90km2 and 0.88km2, so assuming the specific SSY (tons/km2) is similar in both watersheds under pre-disturbance conditions, they should account for roughly the same percentage of sediment contribution to SSYTOTAL. However, for the "+"%.0f"%len(S_Diff_table)+" storms with valid data from both FG1 and FG3, SSYUPPER ranged from "+Percent_Upper_S_min+"-"+Percent_Upper_S_max +"%, and accounted for an average of "+Percent_Upper_S+"% of SSYTOTAL. SSYLOWER ranged from "+Percent_Lower_S_min+"-"+Percent_Lower_S_max +"%, and accounted for an average of "+Percent_Lower_S+"% of SSYTOTAL (Table "+S_Diff_table.table_num+"). By estimating the SSY from forested areas in the LOWER subwatershed from the measured specific SSY from the UPPER subwatershed (which is mainly forest), the relative contributions of forested and disturbed areas from the LOWER subwatershed can be estimated. For the measured storms, roughly 85% of SSY from the LOWER subwatershed is from disturbed areas, despite the disturbed areas only accounting for 5% of the subwatershed area. Similarly, despite only 7% of the TOTAL watershed being disturbed, SSY from disturbed areas accounts for 75% of the SSY from the TOTAL watershed.")
...
document.add_paragraph("Specific SSY from the UPPER subwatershed, which is covered in undisturbed vegetation and only small, natural landslides, was 23 tons/km2 for the 1,123 mm of precipitation meausured. Annual precipitation is on the order of 4,000 mm, so annual specific SSY is roughly 3-4 times the measured specific SSY of 23 tons/km2: 60-80 tons/km2/year. Data in Milliman and Syvitski (1992) suggested unusually high average sediment yields for large watersheds on high-standing, South Pacific Islands on the order of 1,000-3,000 tons/km2/year, however, they acknowledge the role of sediment erodibility and effects of geology, vegetation cover and human activity. Given the high vegetation cover and lack of human activity in the UPPER subwatershed, it is assumed that specific SSY should be several orders of magnitude lower than watersheds presented in Milliman and Syvitski (1992). Milliman and Syvitski (1992) develop an equation to predict specific SSY based on the maximum elevation of the watershed and the basin size. The equation developed for watersheds in Oceania with max elevation of 500-1,000 m predicts 13 tons/km2/year but the equation for max elevations of 1,000-3,000 m predicts 68 tons/km2/year. Calhoun and Fletcher (1999) estimated specific SSY of 140 plus-minus55 tons/km2/year from Hanalei, Kauai, a watershed with similarly steep relief and high precipitation but much larger (54.4km2) as Faga'alu. Using more data on fluvial sedimetn yield, Stock and Tribble (2010) calculated specific SSY of 525 tons/km2/yr from Hanalei, Kauai.")

document.add_paragraph("Specific SSY from the disturbed fraction (5%) of the LOWER subwatershed (0.88km2) was 2,241 tons/km2 for the 1,123 mm of precipitation during the measured storms (roughly 25-33% of annual precipitation). Annual precipitation is on the order of 4,000 mm, so annual specific SSY is roughly 3-4 times the measured specific SSY, approximately 6,000-8,000 tons/km2/year. By the same reasoning, SSY from the TOTAL watershed was 86 tons for the measured storms (25-33% of annual P), so annual SSY is roughly 240-320 tons/year. For the storms in Table 2, specific SSY from the LOWER subwatershed was 6 times higher than specific SSY from the UPPER subwatershed. Specific SSY from the TOTAL watershed, including the UPPER and LOWER subwatersheds, was 4 times higher than from the UPPER, undisturbed subwatershed, suggesting the SSY to Faga'alu Bay has been increased by a factor of 4 over natural levels.")

Percent_QUARRY_S = S_Diff_table_quarry['% LOWER_QUARRY']['Total/Avg']
Percent_FOREST_S = S_Diff_table_quarry['% UPPER']['Total/Avg']
Percent_VILLAGE_S = S_Diff_table_quarry['% LOWER_VILLAGE']['Total/Avg']

document.add_paragraph("SSYEV data measured at FG2 was available for "+No_of_Storm_Intervals_QUA_S+" of the storms in Table "+S_Diff_table.table_num+", so SSYEV from the LOWER subwatershed including the quarry (SSYLOWER_QUARRY) and the village areas below the quarry (SSYLOWER_VILLAGE) could be calculated to determine the relative sediment contribution from these sources. For the measured storms, Total SSY was comprised of an average of "+Percent_FOREST_S+"% from the UPPER subwatershed, "+Percent_QUARRY_S+"% from the LOWER subwatershed above FG2, and "+Percent_VILLAGE_S+"% from the LOWER subwatershed below FG2. Specific SSY from LOWER_QUARRY and LOWER_VILLAGE was 9.2 and 2.4 times higher, respectively, than specific SSY from UPPER subwatershed. Specific SSY from the TOTAL watershed was 2.7 times higher than from UPPER, similar to the larger range of storms in Table 2, where specific SSY was 4 times higher. By estimating the SSY from forested areas in the LOWER_QUARRY and LOWER_VILLAGE subwatersheds from the measured specific SSY from the UPPER subwatershed (which is mainly forest), the relative contributions of forested and disturbed areas from the LOWER_QUARRY and LOWER_VILLAGE subwatershed can be estimated. For the measured storms, roughly 90% of SSY from the LOWER_QUARRY and 61% of SSY from the LOWER_VILLAGE subwatersheds is from disturbed areas, despite the disturbed areas only accounting for 6.5% and 4.9% of the subwatershed area, respectively. Similarly, despite only 6.8% of the TOTAL watershed being disturbed, SSY from disturbed areas accounts for 66% of the SSY from the TOTAL watershed. Specific SSY from the disturbed fraction (6.5%) of the LOWER_QUARRY subwatershed (0.27km2) was 2,460 tons/km2 for the 537 mm of precipitation during the measured storms (roughly 12-15% of annual precipitation). Annual precipitation is on the order of 4,000 mm, so annual specific SSY is roughly 6-8 times the measured specific SSY, approximately 12,000-16,000 tons/km2/year. For the storms in Table 2, specific SSY from the LOWER subwatershed was 6 times higher than specific SSY from the UPPER subwatershed. Specific SSY from the TOTAL watershed, including the UPPER and LOWER subwatersheds, was 4 times higher than from the UPPER, undisturbed subwatershed, suggesting the SSY to Faga'alu Bay has been increased by a factor of 4 over natural levels.    This suggests that the quarry is the most significant sediment source in Faga'alu watershed, and has significantly increased SSYTOTAL above natural levels.")
